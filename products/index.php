...
<div class="section py-5">
    <div class="container">
        <h3 class="text-center"><b>Nossos Produtos</b></h3>
        <hr>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 px-2">
                <div class="card rounded-0 ">
                    ...
                    <div class="card-body">
                        ...
                        <center>
                            <button class="btn btn-primary px-5 rounded-pill btn-sm read-more" data-id="<?= $row['id'] ?>" type="button">Saiba mais...</button>
                        </center>
                    </div>
                </div>
            </div>
