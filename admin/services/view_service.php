...
<div class="container-fluid">
	<dl>
        <dt class="text-muted">Serviço</dt>
    ...
    <div class="text-right">
        <button class="btn btn-sm btn-dark bg-gradient-dark btn-flat" type="button" data-dismiss="modal"><i class="fa fa-times"></i> Fechar</button>
    </div>
</div>