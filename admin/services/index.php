...
<div class="card card-outline rounded-0 card-navy">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Cadastre um Novo Serviço</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Tem certeza de que deseja excluir este serviço permanentemente?","delete_service",[$(this).attr('data-id')])
		})
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Adicionar Novo Serviço","services/manage_service.php")
		})
		$('.view_data').click(function(){
			uni_modal("<i class='fa fa-bars'></i> Detalhes do Serviço","services/view_service.php?id="+$(this).attr('data-id'))
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Atualizar detalhes do serviço","services/manage_service.php?id="+$(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [
