...
<div class="card card-outline rounded-0 card-navy">
	<div class="card-header">
		<h3 class="card-title">Relatório de Serviços Diário</h3>
	</div>
	<div class="card-body">
                ...
                <div class="container-fluid">
                    <form action="" id="filter-form">
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <button class="btn btn-primary btn-sm bg-gradient-primary rounded-0"><i class="fa fa-filter"></i> Filtrar</button>
        ...
        <div class="container-fluid" id="printout">
			<table class="table table-hover table-striped table-bordered">
                ...
                <tfoot>
                    <th class="py-1 text-center" colspan="5">Preço total da mão de obra</th>
    ...
    <div class="d-flex w-100">
        ...
        <div class="col-8 text-center">
            <div style="line-height:1em">
                ...
                <h3 class="text-center mb-0"><b>Relatório de Serviços Diário</b></h3>
                <div class="text-center">a partir de</div>
...
<script>
	$(document).ready(function(){
        ...
        $('#print').click(function(){
            ...
            h.find('title').text('Relatório de Serviços Diários - Visualização para impressão')
