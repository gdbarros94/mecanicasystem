...
<div class="card card-outline rounded-0 card-navy">
	<div class="card-header">
		<h3 class="card-title">Relatório de Vendas Diário</h3>
	</div>
	<div class="card-body">
        ...
        <div class="container-fluid" id="printout">
			<table class="table table-hover table-striped table-bordered">
                ...
                <tfoot>
                    <th class="py-1 text-center" colspan="6">Vendas totais</th>
    ...
    <div class="d-flex w-100">
        ...
        <div class="col-8 text-center">
            <div style="line-height:1em">
                ...
                <h3 class="text-center mb-0"><b>Relatório de Vendas Diário</b></h3>
...
<script>
	$(document).ready(function(){
        ...
        $('#print').click(function(){
            ...
            h.find('title').text('Relatório de Vendas Diário - Visualização para Impressão')
