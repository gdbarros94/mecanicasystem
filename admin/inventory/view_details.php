                    ...
                    <div class="row">
                        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                            <fieldset>
                                ...
                                <dl>
                                    <dt class="text-muted">Produto</dt>
                                    ...
                                    <dt class="text-muted">Disponível no Estoque</dt>
                                    <dd class="pl-4"><?= isset($available) ? format_num($available) : '' ?></dd>
                                    <dt class="text-muted">Vendido</dt>
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                            <fieldset>
                                <legend>Registros de estoque</legend>
                                <table class="table table-bordered table-hover">
                                    <thead>
                                        <tr class="bg-gradient-navy">
                                            <th class="px-2 py-1 text-center">Entrada no Estoque na Data</th>
                                            <th class="px-2 py-1 text-center">Quantidade</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th class="py-1 text-center" colspan="3">Sem dados</th>
                                        </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
