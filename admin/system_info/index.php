	...
	<div class="card card-outline rounded-0 card-navy">
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="short_name" class="control-label">Nome abreviado da Empresa</label>
					<input type="text" class="form-control form-control-sm" name="short_name" id="short_name" value="<?php echo  $_settings->info('short_name') ?>">
				</div>
			<div class="form-group">
				<label for="" class="control-label">Conteúdo de boas-vindas</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Sobre a Empresa</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Logo da Empresa</label>
			...
			<div class="form-group">
				...
				<div class="custom-file">
	              ...
	              <label class="custom-file-label" for="customFile2">Escolher o Arquivo</label>
	            </div>
			</div>
			<div class="form-group d-flex justify-content-center">
			...
			<div class="form-group">
				<label for="" class="control-label">Imagens de banner</label>
				<div class="custom-file">
	              ...
	              <label class="custom-file-label" for="customFile3">Escolher o Arquivo</label>
	            </div>
				<small><i>Escolha carregar novas imagens de banner</i></small>
			</div>
			<?php 
...
<script>
        ...
        $.ajax({
            ...
            success:function(resp){
                ...
                if(typeof resp =='object' && resp.status == 'success'){
                    ...
                    alert_toast("Imagem Deletada com Sucesso","success");
                }else{
                    console.log(resp)
                    alert_toast("An error occured while deleting an Image","error");
                }
	...
	$(document).ready(function(){
		$('.rem_img').click(function(){
            _conf("Você confirma deletar essa imagem permanentemente?",'delete_img',["'"+$(this).attr('data-path')+"'"])
        })
